...
iptables -t filter -A INPUT -p tcp -m multiport --dports 22,53,853,80,9100,9113,5400,5401,5601,9200 -j ACCEPT # ssh, dns, dns, http, prometheus-node-exporter, prometheus-nginx-exporter,logstash
