...
iptables -t filter -A INPUT -p tcp -m multiport --dports 22,53,853,80,8081,8082,9100,9113 -j ACCEPT # ssh, dns, dns, http, prometheus-node-exporter, prometheus-nginx-exporter
